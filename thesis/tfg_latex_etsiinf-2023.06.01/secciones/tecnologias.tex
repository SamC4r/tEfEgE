...
Complementariamente a Tailwind, Booster incorpora \textbf{shadcn/ui}, un sistema de componentes R reutilizables y personalizables como botones, barras laterales, avatares, menús, diálogos, toasts, formularios, tablas, entre otros. Gracias a esto, se utilizan elementos de interfaz ya elaborados y con una apariencia muy moderna y atractiva. Esto permite, ofrecer una experiencia de usuario más profesional y mejora la \textbf{usabilidad} de la aplicación. El uso de esta librería es importante en Booster ya que se consigue una interfaz limpia, moderna y funcional sin dedicar demasiado tiempo al desarrollo de cada componente desde cero. 

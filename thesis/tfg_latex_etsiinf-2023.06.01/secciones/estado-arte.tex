...
A su vez, Mux ofrece características adicionales como visitas del video, análisis de tiempo de retención, geolocalización de los usuarios, entre otras estadísticas de video. 
...
Puede resultar en una opción costosa a largo plazo, en especial para proyectos de gran escala o aquellos que esperen un crecimiento importante en el tráfico, volumen de datos, o videos subidos. Además, al ser un servicio de terceros, se está sujeto a las políticas de precios o cambios en la plataforma. 

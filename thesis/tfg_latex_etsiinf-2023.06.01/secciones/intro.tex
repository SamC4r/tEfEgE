...
\begin{itemize}
  ...
  \item \textbf{Capítulo 3 - Tecnologías Empleadas}: En este capítulo se detalla el análisis tecnológico que fundamenta al proyecto \textit{Booster}. Se describen las principales tecnologías web seleccionadas para el objetivo del proyecto. La finalidad es mostrar que las decisiones técnicas adoptadas responden a criterios de escalabilidad y usabilidad.
  ...
  \item \textbf{Capítulo 8 - Despliegue, feedback de usuarios y riesgos de seguridad}: Este capítulo analiza el proceso de despliegue en la web de la plataforma utilizando servicios en la nube. Además, se presentan opiniones de usuarios y se detallan medidas de seguridad tomadas, ataques reales detectados y mitigados, y su impacto.

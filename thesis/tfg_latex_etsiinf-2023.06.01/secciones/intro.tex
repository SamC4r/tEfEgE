...
\todo{Motivación y necesidades del proyecto}

\todo{Objetivos. Objetivo de todo el trabajo y luego desgranar en sub-objetivos (4 o 5)}

\todo{Planificacion}


\todo{Análisis del coste del proyecto}

\todo{Estructura de la memoria: El resto de la memoria se estructura de la siguiente forma. El capitulo 2 se trata de ..., 3 dice ....}



El verano pasado, mi hermano comenzó a subir vídeos a YouTube regularmente  y de repente, uno de sus vídeos se hizo viral. En cuestión de horas, su canal pasó de tener unos pocos suscriptores a cerca de 30 mil, y su vídeo alcanzó 10 millones de visualizaciones. 
Al momento de monetizar su canal, YouTube le impuso restricciones y no le permitió ganar dinero con su contenido lo cual resultó en una gran decepción para él.

Este suceso sumado a mi propia frustración con la plataforma, tanto como usuario como creador de contenido, me llevó a investigar más sobre alternativas a YouTube y los problemas que encontraban los usuarios y creadores en esta plataforma. Me di cuenta de que no era un caso aislado, sino que muchos otros usuarios y creadores también se enfrentaban a problemas similares, como la excesiva cantidad de anuncios, censuras injustas de ciertos vídeos, dificultad de monetización, dificultad para llegar a una audiencia más amplia, baja calidad de contenido, un algoritmo que favorece el contenido hecho en su mayor parte por inteligencia artificial, baja participación de los usuarios en comunidades, dificultad para encontrar contenido nuevo de calidad, entre otros.

Esto me llevó a la conclusión de que había una necesidad real de una plataforma alternativa a YouTube que ofreciera una mejor experiencia de usuario, más justa, y que abordara estos problemas de manera efectiva. 



Además, se introdujeron nuevas funcionalidades que no se encuentran en YouTube. Algunas de estas son: la posibilidad de crear comunidades de usuarios con intereses similares, un sistema de gamificación, anuncios voluntarios y leaderboards de usuarios y creadores.

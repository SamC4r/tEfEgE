...
\begin{figure}[htbp]
  ...
  \caption{Gestión de usuarios en la plataforma}
\end{figure}
...
\begin{figure}[H]
  ...
  \caption{Exploración y búsqueda de contenido}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1\textwidth]{casos-uso/exploracion-busqueda.png}
  \caption{Interacciones en la plataforma}
\end{figure}
...
\begin{enumerate}
    \item Crear comunidad
    \item Unirse a comunidad
    \item Abandonar comunidad
    \item Consultar comunidades
    \item Buscar comunidades
    \item Consultar videos en una comunidad 
\end{enumerate}
...
\begin{enumerate}
    ...
    \item Consultar canal
    \item Seguir canales
    \item Dejar de seguir canales
\end{enumerate}
...
\begin{enumerate}
    ...
    \item Consultar puntos de experiencia y nivel de canal
    \item Consultar tablas de clasificación
    \item Consultar tienda de recompensas
    \item Comprar artículos de personalización
    \item Equipar artículos de personalización
\end{enumerate}

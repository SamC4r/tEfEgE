...
En esta sección se presenta un diagrama conceptual de la base de datos, siguiendo el modelo entidad relación de Chen. Como el diagrama completo es muy extenso, se ha dividido en varias partes y se han omitido algunos atributos para facilitar su lectura. 
...
Por otro lado, con respecto a las interacciones sociales se tiene lo siguiente:
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.75\textwidth]{diagrama-er/gamificacion-reporte.png}

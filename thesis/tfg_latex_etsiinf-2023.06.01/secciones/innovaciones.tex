...
\begin{itemize}
  ...
  \item \textbf{Explorer}: Página principal de la aplicación donde los videos se muestran en formato de cuadrícula. Se pueden filtrar, buscar y acceder a la sección de videos recientes de comunidades y creadores.
  \item \textbf{Following}: Lista de los canales a los que el usuario sigue
  \item \textbf{Market}: Espacio reservado para la compra de puntos de experiencia, compra de artículos, obtención de premios, desbloqueo de \textit{assets}, entre otros ítems de personalización.
